...
<div class="container">
    <div class="row wrapper-login">
        <div class="col-sm-4 col-md-8 col-md-offset-2">
            ...
            <form class="well form-horizontal" action="{{ url('/password/reset') }}" method="post"  id="login_form">
                {{ csrf_field() }}
                ...
                <fieldset>
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-7 inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input name="email" placeholder="" class="form-control" value="{{ $email or old('email') }}" type="email">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-7 inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                <input name="password_confirmation" placeholder="" class="form-control" value="" type="password">
                            </div>
                        </div>
                    </div>
